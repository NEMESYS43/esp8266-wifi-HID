...
extern const uint8_t data_mdlJs[] PROGMEM;
extern const uint8_t data_mdlCss[] PROGMEM;
extern const uint8_t data_jquery[] PROGMEM;
...
void setup() {
  ...
  server.on("/style.css", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    server.on("/mdl.css", HTTP_GET, [](AsyncWebServerRequest *request) {
    AsyncWebServerResponse *response = request->beginResponse_P(200, "text/css", data_mdlCss, sizeof(data_mdlCss));
    request->send(response);
  });
    server.on("/mdl.js", HTTP_GET, [](AsyncWebServerRequest *request) {
    AsyncWebServerResponse *response = request->beginResponse_P(200, "text/javascript", data_mdlJs, sizeof(data_mdlJs));
    request->send(response);
  });
  ...
  server.on("/jquery.js", HTTP_GET, [](AsyncWebServerRequest *request) {
	  AsyncWebServerResponse *response = request->beginResponse_P(200, "text/javascript", data_jquery, sizeof(data_jquery));
	  request->send(response);
  });
